          ...
          <div className='hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center'>
            ...
            <div className='hero-text col-span-6'>
              ...
              <p className='text-gray-800 text-base leading-relaxed mt-8 font-semibold'>
                Is it your birthday today? Sign up below and I will send you a
                birthday song!
              </p>
                ...
                <div>
                  <form class='mt-8 sm:flex'>
                    ...
                    <div class='mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0'>
                      <button
                        type='submit'
                        class='w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-pink-500 hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                      >
                        Notify me
                      </button>
                    </div>
